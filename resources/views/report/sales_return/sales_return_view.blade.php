...
<div class="content-header">
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">Sales Return Report</h6>

                    <form action="{{ route('sales-return-report.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="d-flex justify-content-start mt-3">
                            ...
                            <button type="submit" name="button" value="3" class="btn btn-primary m-1">Detailed</button>
                            <button type="submit" name="button" value="4" class="btn btn-success m-1">Detailed Excel</button>
                        </div>
                    </form>
                </div>
            </div>

...
<div class="content-header">
    <div class="card">
        <div class="card-body">
            <h6 class="card-title">Dispatch Entry Detailed Report </h6>

            <div class="table-responsive">
                {{-- <table class="table"> --}}
                <table id="dispatchEntryDetailed" class="table">
                    <thead>
                        <tr>
...
<script>
    $(document).ready(function() {
        $('#dispatchEntryDetailed').DataTable({
            processing: true,
            serverSide: true,
            paging: true,
            ajax: {
                url: '{{ route("get-dispatchEntryDetailed") }}',
                type: 'POST',
                data: function(d) {

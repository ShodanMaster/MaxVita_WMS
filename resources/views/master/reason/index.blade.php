...
<div class="content-header">
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="card">
                <div class="card-body">
                    <h6 class="card-title">Reason Master</h6>
                    @include('messages')
                    <div class="row">
                        <div class="col-md-12 text-right">

                            <a class="btn " href="{{route('reason.create')}}"> Add Reason
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" data-toggle="tooltip" data-placement="bottom" title="Add Reason" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-toggle="tooltip" data-placement="bottom" title="Add Reason" class="feather feather-plus-circle text-primary">
                    ...
                    <div class="table-responsive">
                        <table id="reasonsTable" class="table masterTable">
                            <thead>
                                <tr>
        ...
        <div class="modal-content">
            ...
            <form action="{{ route('reason-excel-upload') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <span class="mt-2">You can download excel in predefined format by <a href="{{ URL::to( '/excel_templates/master_templates/reason_template.xlsx')}}" class="text-primary ">Clicking Here</a></span>
                </div>

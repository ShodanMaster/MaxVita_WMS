            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="branchesTable" class="table masterTable">
                            <thead>
                                <tr>
    ...
    <div class="modal-content">
      ...
      <form action="{{ route('branch-excel-upload') }}" method="POST" enctype="multipart/form-data">
          ...
          <div class="modal-body">
            ...
            <span class="mt-2">You can download excel in predefined format by <a href="{{ URL::to( '/excel_templates/master_templates/warehouse_template.xlsx')}}" class="text-primary ">Clicking Here</a></span>
          </div>

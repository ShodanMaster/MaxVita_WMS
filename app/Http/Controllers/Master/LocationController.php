...
class LocationController extends Controller
{
    ...
    public function locationExcelUpload(Request $request)
    {
        ...
        try{
            ...
            Log::error('Location Excel Validation Error: ' . json_encode($e->errors()));
            Alert::toast('Validation failed while importing location Excel.', 'error')->autoClose(3000);
            return redirect()->route('location.index')->withErrors($e->errors());
